...
class FleetManager(Node):
    ...
    def __init__(self, config):
        ...
        @app.get('/open-rmf/exam_ws_fm/status/', response_model=Response)
        ...
        @app.post('/open-rmf/exam_ws_fm/navigate/', response_model=Response)
        ...
        @app.get('/open-rmf/exam_ws_fm/stop_robot/', response_model=Response)
        ...
        @app.get(
            '/open-rmf/exam_ws_fm/action_paths/', response_model=Response
        )
        ...
        @app.post(
            '/open-rmf/exam_ws_fm/start_activity/', response_model=Response
        )
        ...
        @app.post(
            '/open-rmf/exam_ws_fm/toggle_teleop/', response_model=Response
        )
        ...
        @app.post(
            '/open-rmf/exam_ws_fm/toggle_attach/', response_model=Response
        )
