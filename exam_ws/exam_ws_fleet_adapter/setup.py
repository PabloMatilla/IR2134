...
package_name = 'exam_ws_fleet_adapter'
...
setup(
    ...
    entry_points={
        'console_scripts': [
            'fleet_adapter=exam_ws_fleet_adapter.fleet_adapter:main',
            'fleet_manager=exam_ws_fleet_adapter.fleet_manager:main',
            'manage_lane=exam_ws_fleet_adapter.manage_lane:main',
        ],
    },
)
