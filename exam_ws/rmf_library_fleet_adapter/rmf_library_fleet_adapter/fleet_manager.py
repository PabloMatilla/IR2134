...
class FleetManager(Node):
    ...
    def __init__(self, config):
        ...
        @app.get('/open-rmf/rmf_library_fm/status/', response_model=Response)
        ...
        @app.post('/open-rmf/rmf_library_fm/navigate/', response_model=Response)
        ...
        @app.get('/open-rmf/rmf_library_fm/stop_robot/', response_model=Response)
        ...
        @app.get(
            '/open-rmf/rmf_library_fm/action_paths/', response_model=Response
        )
        ...
        @app.post(
            '/open-rmf/rmf_library_fm/start_activity/', response_model=Response
        )
        ...
        @app.post(
            '/open-rmf/rmf_library_fm/toggle_teleop/', response_model=Response
        )
        ...
        @app.post(
            '/open-rmf/rmf_library_fm/toggle_attach/', response_model=Response
        )
