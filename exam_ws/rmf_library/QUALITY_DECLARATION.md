This document is a declaration of software quality for the `rmf_library` package, based on the guidelines in [REP-2004](https://www.ros.org/reps/rep-2004.html).
