^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package rmf_ws_bridges
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
1.4.0 (2022-02-14)
------------------
* Provide an example adapter for a delivery robot with indoor-outdoor capabilities (`#121 <https://github.com/open-rmf/rmf_ws/pull/121>`_)
